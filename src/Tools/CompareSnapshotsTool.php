...
class CompareSnapshotsTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'canvas.snapshots.compare.GET';
    }

    public function getDescription(): string
    {
        return 'GET /canvas/snapshots/compare - Vergleicht zwei Snapshots und zeigt Unterschiede. ERFORDERLICH: snapshot_a_id, snapshot_b_id.';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        try {
            ...
            $snapshotA = CanvasSnapshot::query()
            ...
            $snapshotB = CanvasSnapshot::query()
                ->whereHas('canvas', fn($q) => $q->where('team_id', $teamId))
                ->find($snapshotBId);
