...
namespace Platform\Canvas\Tools\Concerns;

use Platform\Core\Contracts\ToolContext;
use Platform\Core\Contracts\ToolResult;
use Platform\Core\Models\Team;

trait ResolvesCanvasTeam
{
    /**
    ...
    protected function resolveTeam(array $arguments, ToolContext $context): array
    {
        ...
        if (!$teamId) {
            return [
                'team_id' => null,
                'team' => null,
                'error' => ToolResult::error('MISSING_TEAM', 'Kein Team angegeben und kein Team im Kontext gefunden. Bitte team_id angeben.'),
            ];
        }
